...
def model_factory(model_type: str):
    ...
    match model_type:
        case 'RandomForest': 
            return RandomForestRegressor(criterion='squared_error')
        case 'ExtraTrees':
...
class MLmodel(object):
    ...
    def optimize(self, X, y, params= {}):
        ...
        """
        #TODO -> questa funzione è presa da un codice che usavo per un problema di classificazione,
        #        quindi non va bene per un regressore. Andrebbe modificata
    ...
    def plot_features_importances(self, train_features):
        """
